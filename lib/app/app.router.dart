...
import 'package:promogoai/models/chat_room.dart' as _i36;
import 'package:promogoai/models/course_model.dart' as _i34;
import 'package:promogoai/models/product.dart' as _i33;
...
import 'package:promogoai/ui/views/chat/chat_view.dart' as _i31;
...
class StackedRouter extends _i1.RouterBase {
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i28.LiveViewerView: (data) {
      ...
      return _i32.MaterialPageRoute<dynamic>(
        builder: (context) => _i28.LiveViewerView(
            key: args.key, preloadedViewModel: args.preloadedViewModel),
        settings: data,
      );
    },
    ...
    _i31.ChatView: (data) {
      ...
      return _i32.MaterialPageRoute<dynamic>(
        builder: (context) =>
            _i31.ChatView(key: args.key, chatRoom: args.chatRoom),
        settings: data,
      );
    },
  };
...
class LessonViewArguments {
  ...
  final _i34.Lesson lesson;

  final List<_i34.Lesson> allLessons;
...
class LiveViewerViewArguments {
  ...
  final _i35.LiveViewerViewModel? preloadedViewModel;

  @override
  String toString() {
    return '{"key": "$key", "preloadedViewModel": "$preloadedViewModel"}';
  }

  @override
  bool operator ==(covariant LiveViewerViewArguments other) {
    if (identical(this, other)) return true;
    return other.key == key && other.preloadedViewModel == preloadedViewModel;
  }

  @override
  int get hashCode {
    return key.hashCode ^ preloadedViewModel.hashCode;
  }
}
...
class ChatViewArguments {
  ...
  final _i36.ChatRoomModel chatRoom;

  @override
  String toString() {
    return '{"key": "$key", "chatRoom": "$chatRoom"}';
  }

  @override
  bool operator ==(covariant ChatViewArguments other) {
    if (identical(this, other)) return true;
    return other.key == key && other.chatRoom == chatRoom;
  }

  @override
  int get hashCode {
    return key.hashCode ^ chatRoom.hashCode;
  }
}
...
extension NavigatorStateExtension on _i37.NavigationService {
  ...
  Future<dynamic> navigateToLessonView({
    _i32.Key? key,
    required _i34.Lesson lesson,
    required List<_i34.Lesson> allLessons,
  ...
  Future<dynamic> navigateToLiveViewerView({
    _i32.Key? key,
    _i35.LiveViewerViewModel? preloadedViewModel,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return navigateTo<dynamic>(Routes.liveViewerView,
        arguments: LiveViewerViewArguments(
            key: key, preloadedViewModel: preloadedViewModel),
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> navigateToChatView({
    _i32.Key? key,
    required _i36.ChatRoomModel chatRoom,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return navigateTo<dynamic>(Routes.chatView,
        arguments: ChatViewArguments(key: key, chatRoom: chatRoom),
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);

            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xFF00ACC1), // Cyan as in image
  ...
  Widget _buildGenderOption(RegisterViewModel viewModel, String value, IconData icon) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(color: isSelected ? const Color(0xFF00ACC1) : Colors.grey[300]!),
          borderRadius: BorderRadius.circular(15),
          color: isSelected ? const Color(0xFF00ACC1).withOpacity(0.05) : Colors.white,
        ),
        child: Row(
          children: [
          ...
          Row(
            children: [
              ...
              InkWell(
                ...
                child: const Text('Connectez-vous', style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold, fontSize: 13)),
              ),
            ],
          ),
        ],

...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    ...
    return Product(
      ...
      name: (json['title'] as String?) ?? 'Sans Titre',
      price: priceStr,
      imageUrl: imgUrl,
      gallery: gal.isEmpty ? [''] : gal,
      description: (json['description'] as String?) ?? '',
      location: (json['location'] as String?) ?? '',
      sellerName: (json['seller_name'] as String?) ?? (json['seller_username'] as String?) ?? 'Vendeur de la plateforme',
      sellerPhone: (json['seller_phone'] as String?) ?? '',
      originalLanguage: (json['language'] as String?) ?? 'fr',
      canShowWhatsapp: (json['can_show_whatsapp'] as bool?) ?? false,
      canShowPhone: (json['can_show_phone'] as bool?) ?? false,
      hasPremiumVisibility: (json['has_premium_visibility'] as bool?) ?? false,
      planName: pName,
    );
  }
}
